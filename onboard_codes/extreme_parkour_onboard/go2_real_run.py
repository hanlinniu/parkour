...
def main(args):
    ...
    base_model = torch.jit.load(os.path.join(save_folder, "0528-distill-policy-gaussian-noise-delta-y-terrain-alienware-29500-base_jit.pt"), map_location=device)
    base_model.eval()
    ...
    vision_model = torch.load(os.path.join(save_folder, "0528-distill-policy-gaussian-noise-delta-y-terrain-alienware-29500-vision_weight.pt"), map_location=device)
